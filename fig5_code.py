...
if __name__ == "__main__":
    ...
    # Read in the data
    permut_df = pd.read_csv(f"{data_folder}/fig5_data_permut.csv")
    shap_df = pd.read_csv(f"{data_folder}/fig5_data_shap.csv")
    ...
    print(
        f"--- Finished exporting figure  5, took {time.time() - start_time:,.2f} seconds ---"
    )