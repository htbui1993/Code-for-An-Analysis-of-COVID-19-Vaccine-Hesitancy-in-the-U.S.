...
if __name__ == "__main__":
    ...
    fig = go.Figure(
        layout=dict(
            ...
            font=dict(family="Time News Roman", size=12),
            height=200,
            width=850,
        )
    ).set_subplots(
    ...
    fig.update_annotations(font=dict(family="Time News Roman", size=12))
    ...
    # Export the figure
    fig.write_image(f"{image_folder}/(fig6)aspe_delphi_vhb.png", scale=4)
    print(
