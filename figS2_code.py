...
if __name__ == "__main__":
    ...
    # Read in the data
    corr_matrix = pd.read_csv(f"{data_folder}/figS2_data.csv", index_col=0)
    ...
    # Export the figure
    fig.write_image(f"{image_folder}/corr_heatmap.png", scale=4)
    print(
        f"--- Finished exporting figure  S2, took {time.time() - start_time:,.2f} seconds ---"
    )
